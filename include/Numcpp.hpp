...
class Numcpp
{
    private:
        ...
        /// \param list1 first list compare
        /// \param list2 second list compare
        /// \return vector where True if the first value is inferior at the same position False if not
        ...
        /// \param list1 first list compare
        /// \param list2 second list compare
        /// \return vector where True if the first value is inferior or equal at the same position False if not
        ...
        /// \param list1 first list compare
        /// \param list2 second list compare
        /// \return vector where True if the first value is superior at the same position False if not
    ...
    public:
        ...
        /// \return The minimal value float
        float min1D(void);
        ...
        /// \return The maximal value float
        float max1D(void);
